...
// takes precedence), then the extendai-lab-owned global credentials file in the user
// config dir (where `extendai-lab setup` writes keys, so they resolve from any
