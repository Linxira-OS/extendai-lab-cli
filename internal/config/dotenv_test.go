...
// TestLoadDotEnvReadsGlobalCredentials proves `extendai-lab setup`'s target — the
// extendai-lab-owned credentials file in the user config dir — is loaded from any
