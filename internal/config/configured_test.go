...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "extendai-lab_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "extendai-lab_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "extendai-lab_TEST_MISSING"}, false},
