...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — extendai-lab end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "extendai-lab", "path to the extendai-lab binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 extendai-lab e2e benchmark\n\n")
