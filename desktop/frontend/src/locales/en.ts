...
export const en = {
  ...
  "settings.style.carbon.desc": "Warm charcoal with a teal accent — richer texture, higher contrast for long focus.",
  "settings.style.nocturne.zh": "Soft",
  "settings.style.nocturne.note": "Calm",
  "settings.style.nocturne.desc": "Soft violet night with larger radii — gentle, reading-oriented.",
