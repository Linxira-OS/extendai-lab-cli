...
func desktopConfigDir() string {
	...
	if err != nil {
		...
		return filepath.Join(home, ".extendai-lab")
	}
...
func topicTitlesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".extendai-lab", topicTitlesFile)
}
...
func topicTitleSourcesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".extendai-lab", topicTitleSourcesFile)
}
...
func globalWorkspaceRoot() string {
	...
	if err != nil {
		home, _ := os.UserHomeDir()
		return filepath.Join(home, ".extendai-lab", "global-workspace")
	}
